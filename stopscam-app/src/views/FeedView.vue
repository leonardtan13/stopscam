  ...
  <div>
                  ...
                  <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div v-if="isDisabled()">
                      <p class="text-amber-700">
                        All fields have to be filled in before post submission.
                      </p>
                    </div>
                    <div v-else>
                      <p class="text-teal-700">
                        You are all set. Click Post to finalize your submission.
                      </p>
                    </div>
                  </div>
                </div>
    ...
    <nav class="md:px-4 px-2 mx-auto my-5 w-5/6 sm:w-2/3 md:w-1/3 rounded-lg">
      ...
      >
        <div>
          <button
            class="block md:px-6 md:py-4 p-2 rounded-lg text-white text-md sm:text-lg w-full"
    ...
    <div
      ...
      class="w-5/6 sm:w-2/3 mx-auto bg-white rounded-xl"
    >
      <!-- Nav Filter -->
    ...
    <div
      v-else
      class="sm:px-20 py-10 w-3/5 mx-auto bg-white rounded-md shadow-xl border"
    >
